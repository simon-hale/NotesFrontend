export default {
  ...
  fileDisk: {
    root: 'root',
    uploadDialogCreateTitle: 'Create',
    uploadDialogUploadTitle: 'Upload',
    uploadSwitcherLabel: 'Switch between folder and file',
    ...
    uploadTargetUnavailable: 'The current directory is not ready yet. Please try again.',
    uploadStageIdle: 'Idle',
    uploadStageTransferring: 'Uploading to cloud…',
    uploadStageFinalizing: 'Finalizing file metadata…',
    uploadCredentialScopeInvalid: 'Cloud credential validation failed. This upload has been stopped.',
